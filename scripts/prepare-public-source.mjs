...
const DOCS = new Set(['INSTALLATION.md', 'TEST-BETA.md', 'BETA-MAC.md', 'VPS.md', 'SECURITY.md', 'PRIVACY.md', 'PUBLICATION.md', 'PROTOCOL.md', 'SITE-PRESENTATION.md', 'VALIDATION-0.2.0.md', 'SIGNATURES.md', 'UPDATES.md', 'agent-world-updater.pub', 'agent-world-release.pub', 'allowed-signers', 'asset-rights.json', 'dependency-rights.json', 'dependency-licenses.json']);
