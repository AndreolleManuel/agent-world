...
Application pour **Mac Apple Silicon**, sans restriction à la seule version de macOS utilisée pour la recette. La distribution non notarisée est un choix confirmé du projet ; Developer ID et notarisation ne sont pas des conditions de publication. Il reste à tester le téléchargement exact avec quarantaine et l’exception individuelle expliquée aux utilisateurs. Ne pas retirer globalement Gatekeeper. [Installation](INSTALLATION.md) et [validation effective](VALIDATION-0.2.0.md).
